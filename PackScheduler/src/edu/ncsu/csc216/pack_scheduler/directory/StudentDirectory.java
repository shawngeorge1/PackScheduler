...
public class StudentDirectory {
    ...
    public boolean addStudent(String firstName, String lastName, String id, String email, String password,
        ...
        return addStudent(firstName, lastName, id, email, password, repeatPassword, maxCredits, null);
    }
     ...
     * @param repeatPassword student's repeated password
     * @param maxCredits     student's max credits.
     * @param hash           hash in case we don't want default
     * @return true if added
     */
    public boolean addStudent(String firstName, String lastName, String id, String email, String password,
            String repeatPassword, int maxCredits, String hash) {
        String hashPW = "";
        String repeatHashPW = "";
        ...
        try {
            ...
            MessageDigest digest1 = MessageDigest.getInstance(hash);
            digest1.update(password.getBytes());
            hashPW = new String(digest1.digest());

            MessageDigest digest2 = MessageDigest.getInstance(hash);
    ...
    /**
     * Get a student from the directory by their id
     * 
     * @param id id to search for student by
     * @return the student
     */
