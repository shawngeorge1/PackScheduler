...
//        }
    ...
    /**
     * Tests courses implementation of isDuplicate
     */
    @Test
    public void testIsDuplicate() {
        ...
        Activity c3 = new Course("FUN101", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, "A");
        assertFalse(c1.isDuplicate(c3));
    }
    
    /**
     * Tests getting a courses information
     */
    @Test
    public void testGetDisplayArrays() {
        Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
        System.out.println(Arrays.toString(c1.getShortDisplayArray()));
        String[] expected = { "CSC216", "001", "Programming Concepts - Java", "MW 1:30PM-2:45PM" };
        assertEquals(expected[3], c1.getShortDisplayArray()[3]);
        assertEquals(expected[0], c1.getLongDisplayArray()[0]);
    }
}
