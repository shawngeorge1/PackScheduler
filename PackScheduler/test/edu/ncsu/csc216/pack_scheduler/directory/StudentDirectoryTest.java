...
public class StudentDirectoryTest {
    ...
    public void testAddStudent() {
        ...
        //Test valid Student
        sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, PASSWORD, MAX_CREDITS, null);
        ...
        try {
            sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, "1", MAX_CREDITS);
            fail();
        } catch (IllegalArgumentException e) {
            assertEquals(1, sd.getStudentDirectory().length);
        }
        try {
            sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, "1", MAX_CREDITS, "NOTAHASH");
            fail();
        } catch (IllegalArgumentException e) {
            assertEquals(1, sd.getStudentDirectory().length);
        }
        ...
        assertTrue(sd.addStudent(FIRST_NAME, LAST_NAME, ID + "2", EMAIL, PASSWORD, PASSWORD, MAX_CREDITS));
    }
    ...
    public void testSaveStudentDirectory() {
        ...
        //Add a student
        sd.addStudent("Zahir", "King", "zking", "orci.Donec@ametmassaQuisque.com", "pw", "pw", 15, null);
        assertEquals(1, sd.getStudentDirectory().length);
        ...
        try {
            sd.saveStudentDirectory(slash + "home/sesmith5/actual_student_records.txt");
    ...
    public void testGetStudentById() {
        ...
        assertNull(sd.getStudentById("notexistsan"));
